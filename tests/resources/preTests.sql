...
--
-- Structure of table `hs_read`
--

DROP TABLE IF EXISTS `hs_read`;
CREATE TABLE `hs_read` (
  `key`     INT(11)             NOT NULL,
  `date`    DATE                NOT NULL,
...
INSERT INTO `hs_read` (`key`, `date`, `float`, `varchar`, `text`, `set`, `union`, `null`) VALUES
...
--
-- Structure of table `hs_write`
--

DROP TABLE IF EXISTS `hs_write`;
CREATE TABLE `hs_write` (
  `k` INT(11)     NOT NULL,
...
--
-- Data of table `hs_write`
--

INSERT INTO `hs_write` (`k`, `v`) VALUES
  (2, 'inserted');